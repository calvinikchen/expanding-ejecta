# expanding-ejecta
[comment]:[![arXiv](https://img.shields.io/badge/arXiv-2301.00822%20-green.svg)](https://arxiv.org/abs/2504.20132)

This GitHub page is the home of expanding-ejecta; the code for generating P Cygni line profile in a ellipsoidal supernova, calculating the intensity correlator of the image as seen by an intensity interferometer described in [2504.20132](https://arxiv.org/abs/2504.20132) and [2505.08856](https://arxiv.org/abs/2505.08856) capable of measuring supernova morphology and Hubble constant. This code is JAX compatible with just-in-time speed up and autograd for potential faster Markov-Chain Monte-Carlo (MCMC) methods.
...
The `PaperPlots` folder contains the Jupyter Notebook scripts used to generate the plots shown in [2504.20132](https://arxiv.org/abs/2504.20132).
The `H0 Determination` folder contains the Mathematica scripts used to generate the plots and results shown in [2505.08856](https://arxiv.org/abs/2505.08856).
